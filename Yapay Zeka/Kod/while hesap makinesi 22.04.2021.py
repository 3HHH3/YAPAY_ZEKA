...
while döngüsünü daha önce yazdığımız hesap makinemize uygulayalım
Gördüğünüz gibi işlemden çıkabilmek için "q" harfine bastığımızda 
ana menüye dönecektir ve sürekli yeni bir işlem yapmamızı istiyecektir.
"""
giriş = """
(1) topla
(2) çıkar
